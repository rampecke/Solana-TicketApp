...
class PreviewModel: Model {
    override init() {
        ...
        self.collections = [CollectionNFT(uuid: UUID(), title: "More - Macklemore", eventId: UUID(), possibleCollectables: [self.getExampleCollectable(), self.getExampleCollectable2(), self.getExampleCollectable(), self.getExampleCollectable2(),self.getExampleCollectable(), self.getExampleCollectable2()]), CollectionNFT(uuid: UUID(), title: "More - Macklemore", eventId: UUID(), possibleCollectables: [self.getExampleCollectable(), self.getExampleCollectable2(), self.getExampleCollectable(), self.getExampleCollectable2()])]
